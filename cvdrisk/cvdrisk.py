...
print ("Based on the data provided, your result is %s, which equates to a 10 year cardiovascular risk of %s" % (value, convert_risk(value)))
#print(value)
